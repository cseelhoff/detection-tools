...
try {
    ...
    $env:SUBSCRIPTION_ID = "d8948eef-cc0c-4e7a-a62c-df1568413b9a";
    $env:RESOURCE_GROUP = "rg-caleb";
    $env:TENANT_ID = "0e29c8dd-8052-4799-9d89-0481b58ca4ad";
    $env:LOCATION = "eastus2";
    $env:AUTH_TYPE = "token";
    $env:CORRELATION_ID = "bb5957e8-35dc-42ff-8865-618bbb3618ab";
